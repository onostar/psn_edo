...
<head>
    ...
    <title>PSN Edo State | Pharmacies</title>
...
<section class="top_head" id="topHeader">
        <div class="social_media">
            <p>
                <span>Call us </span>(+234) 901 234 5678
            </p>
            <p>
                info@psnedo.com
            </p>
        ...
        <div class="contact_phone">
            <ul>
                ...
                <li><a href="pharmacies.php">Find pharmacy</a></li>
                <li><a href="views/login_page.php">Pay Bills</a></li>
