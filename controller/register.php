        ...
        if(strlen($phone_number) != 11){
            ...
            if($check_user->rowCount() > 0){
                ...
                if(move_uploaded_file($_FILES['passport']['tmp_name'], $passport_folder)){
                    $insert_user = $connectdb->prepare("INSERT INTO users (first_name, last_name, pharmacy, phone_number, gender, user_email, passport, pcn_number, reg_number, pharmacy_location, pharmacy_address, pharmacist_class, dob) VALUES (:first_name, :last_name, :pharmacy, :phone_number, :gender, :user_email, :passport, :pcn_number, :reg_number, :pharmacy_location, :pharmacy_address, :pharmacist_class, :dob)");
