<?php
    ...
    if(isset($_POST['add_payment'])){
        ...
        $check_status = $connectdb->prepare("SELECT * FROM payments WHERE pcn_number = :pcn_number AND payment_status = 0  AND YEAR(tdate) = YEAR(CURDATE())");
        ...
        if($check_status->rowCount() > 0){
            ...
            $check_status = $connectdb->prepare("SELECT * FROM payments WHERE pcn_number = :pcn_number AND payment_status = 1  AND YEAR(tdate) = YEAR(CURDATE())");
            $check_status->bindvalue("pcn_number", $pcn);
            $check_status->execute();
            if($check_status->rowCount() > 0){
